...
(function( $ ) {
	...
	$.fn.ssPlayer=function(options){
		...
		function buildPlayer(){
			...
			$("#prev_track_button #button #icon").append('<img src="images/prevBtn.png"/>');
			$("#play_track_button #button #icon").append('<img src="images/playBtn.png"/>');
			$("#play_track_button #button #reverseIcon").append('<img src="images/pause.png"/>');
			$("#next_track_button #button #icon").append('<img src="images/nextBtn.png"/>');
			$("#sound_button #button #icon").append('<img src="images/speakerOn.png"/>');
			$("#sound_button #button #reverseIcon").append('<img src="images/speakerOff.png"/>');
			$("#shuffle_button #button #icon").append('<img src="images/shuffle.png"/>');
			$("#replay_button #button #icon").append('<img src="images/replay.png"/>');
			$("#list_button #button #icon").append('<img src="images/list.png"/>');
		...
		function replaceImage(imagePath){
			if(imagePath==""){
				imagePath="images/thumbDefault.jpg"	;
			}
			var img = new Image();			
			$(img).load(function(e){				
				setImage(imagePath);					
